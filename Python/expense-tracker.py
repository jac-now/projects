...
#define the ExenseTrackerApp class and methods        
class ExpenseTrackerApp:
    def __init__(self, root):
        ...
        self.expenses = []
        self.categories = ["Mortgage", "Groceries", "Vehicles", "Bills", "Fuel", "Subscriptions", "Savings"]
    ...
    def get_initial_budget(self):
        while True:
            budget = simpledialog.askfloat("Monthly Budget", "Enter your monthly income:", minvalue=0.01)
    ...
    #Calculates the expenses vs budget
